...
/*
  ...
  Usage:
    node scripts/inspect-tabs.js --doc <DOCUMENT_ID> [--env <PATH_TO_.env>] [--token <PATH_TO_.token.json>]
  ...
  try {
    ...
    try {
      ...
      tabs.forEach((t, idx) => {
        ...
        tabSummaries.push({ id, title, lengths: { documentBody: lenDocBody, body: lenBody, tabBody: lenTabBody, content: lenContent } });
      });
    } catch (e) {
